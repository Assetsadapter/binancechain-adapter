...
func (bs *BNBBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *BNBBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *BNBBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *BNBBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *BNBBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *BNBBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *BNBBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
